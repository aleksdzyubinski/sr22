...
//  $mail->addCC('paul.ryazanov@gmail.com', 'Paul');
  ...
  $mail->Subject = "Motorcycle/Scooter Insurance";
  ...
  {
      $mail->Body .= "<p>I need an Sr22 filing</p>";
  }
...
<!-- End Google Tag Manager -->
    ...
    <div class="jumbotron white motorcycle-bg">
      <div class="container">
        <h1>Motorcycle/Scooter Insurance Rates As Low As <span class="text-muted">$6/month</span></h1>
        <div class="row">
        <div class="col-md-6">
          <p>We work with the top rated Motorcycle Insurance companies to provide the best coverage and the lowest rates in California. No matter what you own – a sport bike, cruiser, standard, touring bike, or a sweet custom ride, you can turn to us for great rates and the best coverage. </p>
          <ul>
            <li>5 star Yelp Reviews</li>
            <li>No Hidden fees</li>
            <li>Print Your ID Card Online</li>
          </ul>
          ...
          <form class="form-horizontal" method="post"  action="<?php echo $_SERVER['PHP_SELF']; ?>" >
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="non-owner" value="true">I need an SR22 filing
                  </label>
                </div>
    ...
    <main class="main">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="sidebar">
              <h3>Why do you need insurance for your motorcycle?</h3>
              <ul>
                <li>If you're in an accident or your motorcycle is stolen, it costs money, often a lot of money, to fix or replace it.</li>
                <li>If you or a passenger is injured in an accident, medical costs can be extremely expensive.</li>
                <li>If your motorcycle is responsible for damage or injury to others, you may be sued for much more than you're worth.</li>
              </ul>
            </div>  
          </div>
        </div>
